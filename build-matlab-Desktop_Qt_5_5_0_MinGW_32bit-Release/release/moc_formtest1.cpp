/****************************************************************************
** Meta object code from reading C++ file 'formtest1.h'
**
...
#include "../../matlab/formtest1.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'formtest1.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 9, 16), // "on_solve_clicked"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "Formtest\0on_solve_clicked\0"
};
...
void Formtest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Formtest *_t = static_cast<Formtest *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_solve_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Formtest::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Formtest.data,
      qt_meta_data_Formtest,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Formtest::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Formtest.stringdata0))
        return static_cast<void*>(const_cast< Formtest*>(this));
